<div class="row">
	<div class="col-md-3">
		<div class="card p-4">
			<div class="card-body d-flex justify-content-between align-items-center">
				...
				<div class="h2 text-muted"><i class="icon icon-people"></i></div>
			</div>
		</div>
	</div>
	...
	<div class="col-md-3">
		<div class="card p-4">
			...
			<div class="h2 text-muted"><i class="icon icon-wallet"></i></div>
			</div>
		</div>
	</div>
	...
	<div class="col-md-3">
		<div class="card p-4">
			...
			<div class="h2 text-muted"><i class="icon icon-cloud-download"></i></div>
			</div>
		</div>
	</div>
	...
	<div class="col-md-3">
		<div class="card p-4">
			...
			<div class="h2 text-muted"><i class="icon icon-clock"></i></div>
			</div>
		</div>
	</div>
